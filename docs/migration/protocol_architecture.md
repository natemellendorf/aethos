...
- [Federation protocol v1 contract](../spec/FEDERATION_PROTOCOL_V1.md)
...
Federation contract details are canonically documented in [FEDERATION_PROTOCOL_V1](../spec/FEDERATION_PROTOCOL_V1.md); implementation alignment remains `VERIFY` in the matrix until conformance is confirmed.
